		...
		<div class="widget">
			<div class="title">
				<span class="titleIcon">
					<div class="checker" id="uniform-titleCheck"><span><input type="checkbox" name="titleCheck"
								id="titleCheck" style="opacity: 0;"></span></div>
				</span>
			...
			<table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
				...
				<tbody class="list_item">
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="21"
										name="id[]" style="opacity: 0;"></span></div>
						</td>

						<td class="textC">21</td>

						<td>
							Nguyễn Lê Thành Công </td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="20"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="19"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="18"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="17"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="16"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="15"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="14"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="13"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
					...
					<tr>
						<td>
							<div class="checker" id="uniform-undefined"><span><input type="checkbox" value="12"
										name="id[]" style="opacity: 0;"></span></div>
						</td>
