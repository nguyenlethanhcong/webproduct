...
--
-- Client :  localhost
-- Généré le :  Dim 04 Août 2019 à 12:07
...
(10, 'nguyenvana123', '25f9e794323b453885f5181f1b624d0b', 'Nguyễn Văn A', 0),
(8, 'nguyenlethanhcong', '08081999', 'Nguyễn Lê Thành Công', 0);
...
--
-- Contenu de la table `admin_group`
--
...
--
-- Structure de la table `content_static`
--
...
--
-- Contenu de la table `content_static`
--
...
(22, 0, 0, 20, 'Nguyễn Lê Thành Công', 'nguyenlethanhcong.10k13@gmail.com', '0357188134', '9500000.0000', 'offline', '', 'abc', '', 1564720054);
...
(20, 'Nguyễn Lê Thành Công', 'nguyenlethanhcong.10k13@gmail.com', '0357188134', 'Quận 9, TP. HCM', 'a1599c127e2f26cbeeff14c9e95edb88', 1564719976);
...
--
-- Index pour la table `content_static`
--
...
--
-- AUTO_INCREMENT pour la table `content_static`
--
ALTER TABLE `content_static`
